...
CREATE DIRECTORY PHOTO AS 'C:\oraclexe\app';

DECLARE 
L_BLOB BLOB;
BEGIN 
 --SELECT IMAGE INTO L_BLOB FROM IMAGE_TEST
 --WHERE ID = 1 FOR UPDATE;
 DBMS_LOB.OPEN(L_BLOB, DBMS_LOB.LOB_READWRITE);
 DBMS_LOB.LOADFROMFILE(L_BLOB, 'testImage.jpg', DBMS_LOB.GETLENGTH(BFILENAME('PHOTO', 'testImage.jpg')));
 DBMS_LOB.CLOSE(L_BLOB);
 
 INSERT INTO IMAGE_TEST
 VALUES(2, 'testImage.jpg', L_BLOB);
END;
